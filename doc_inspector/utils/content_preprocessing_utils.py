...
#     """
#     Extract text from PDF documents based on upload metadata and print them.
    
#     Args:
#         upload_metadata: List of dictionaries containing document metadata
        
#     Returns:
#         Dictionary with doc_id as key and extracted text as value
#     """
#     extracted_texts = {}
...
#             extracted_texts[doc_id] = "Document unavailable"
#             continue
        
#         # Check if file exists
#         if not local_path.exists():
#             print(f"❌ ERROR: File not found at {local_path}")
#             extracted_texts[doc_id] = "File not found"
#             continue
        
#         # Check if it's a PDF file
#         if not file_name.endswith('.pdf'):
#             print(f"⚠️  SKIPPED: {file_name} is not a PDF file")
#             extracted_texts[doc_id] = "Not a PDF file"
#             continue
...
#                     extracted_texts[doc_id] = text_content.strip()
#                     print(f"✅ Successfully extracted text from {doc_id}")
                    
#                     # Print a preview of the extracted text
#                     print(f"\n📋 TEXT PREVIEW for {doc_id}:")
#                     print("─" * 40)
#                     preview = text_content.strip()[:500]  # First 500 characters
#                     print(text_content)
...
#                     extracted_texts[doc_id] = "No text content found"
        
#         except Exception as e:
#             print(f"❌ ERROR processing {doc_id}: {str(e)}")
#             extracted_texts[doc_id] = f"Error: {str(e)}"
...
#     successful_extractions = len([text for text in extracted_texts.values() 
#                                 if not text.startswith(("Document unavailable", "File not found", "Not a PDF file", "Error:", "No text content"))])
    
#     print(f"Total documents processed: {total_docs}")
#     print(f"Successful extractions: {successful_extractions}")
#     print(f"Failed/Skipped: {total_docs - successful_extractions}")
    
#     for doc_id, status in extracted_texts.items():
#         if status.startswith(("Document unavailable", "File not found", "Not a PDF file", "Error:", "No text content")):
